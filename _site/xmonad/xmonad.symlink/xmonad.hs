...
--
myWorkspaces    = ["web", "code", "email", "music", "eclipse", "vm"]
        ++ map show [7..9]
...
main = do
    ...
    trayproc <- spawnPipe "killall trayer; sleep 1; trayer --edge top --align left --SetDockType true --SetPartialStrut true --expand true --width 3 --alpha 0 --transparent true --height 18 --tint 000000"
