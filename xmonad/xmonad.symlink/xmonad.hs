...
main = do
    ...
    trayproc <- spawnPipe "killall trayer; sleep 5; trayer --edge top --align left --SetDockType true --SetPartialStrut true --expand true --width 5 --alpha 0 --transparent true --height 18 --tint 000000"
